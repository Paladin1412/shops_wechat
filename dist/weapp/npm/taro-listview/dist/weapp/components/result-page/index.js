(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["npm/taro-listview/dist/weapp/components/result-page/index"],{
...
var Page = (_temp2 = _class = function (_BaseComponent) {
  ...
  _createClass(Page, [{
    ...
    key: "funPrivatebabzz",
    value: function funPrivatebabzz() {
      return this.props.fetchInit.apply(undefined, Array.prototype.slice.call(arguments, 1));
    }
  }]);

  return Page;
}(_taroWeapp.Component), _class.$$events = ["funPrivatebabzz"], _class.multipleSlots = true, _class.$$componentPath = "node_modules/taro-listview/dist/weapp/components/result-page/index", _temp2);
...
module.exports = __webpack_require__.p + "npm/taro-listview/dist/weapp/components/result-page/index.wxml";
