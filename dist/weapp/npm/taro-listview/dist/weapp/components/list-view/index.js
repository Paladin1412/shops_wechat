(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["npm/taro-listview/dist/weapp/components/list-view/index"],{
  ...
  var ListView = (_temp2 = _class = function (_BaseComponent) {
    ...
    _createClass(ListView, [{
      ...
      value: function componentDidMount() {
        ...
        this.moveBox(0);
        if (this.props.lazy) {
          _taroWeapp2.default.createSelectorQuery().in(this.$scope).select('.scrollView').boundingClientRect().exec(function (res) {
      ...
      value: function _createData() {
        ...
        var anonymousState__temp2 = (0, _taroWeapp.internal_inline_style)({ minHeight: '100%', overflowY: 'hidden' });
        ...
        var anonymousState__temp3 = (0, _taroWeapp.internal_inline_style)(blockStyle);
        var anonymousState__temp4 = (0, _taroWeapp.internal_inline_style)({ height: damping + "px", marginTop: "-" + damping + "px" });
        _taroWeapp.propsManager.set({
          "isLoaded": isLoaded || isError,
          "selector": selector
        }, $compid__185, $prevCompid__185);
        downLoading && !this.__props.customizeLoading && _taroWeapp.propsManager.set({
          "color": circleColor
    ...
    return ListView;
  }(_taroWeapp.Component), _class.$$events = ["handleScrollToLower", "onScroll", "anonymousFunc0", "anonymousFunc1", "anonymousFunc2", "anonymousFunc3"], _class.multipleSlots = true, _class.$$componentPath = "node_modules/taro-listview/dist/weapp/components/list-view/index", _temp2);
...
Component(__webpack_require__(/*! @tarojs/taro-weapp */ "./node_modules/@tarojs/taro-weapp/index.js").default.createComponent(ListView));
...
module.exports = __webpack_require__.p + "npm/taro-listview/dist/weapp/components/list-view/index.wxml";
...
function lazyScroll(key, selector, height) {
  var query = _taroWeapp2.default.getEnv() === 'WEB' ? ".lazy-image-" + key : selector + " >>> .lazy-image-" + key;
  throttle(function () {
    _taroWeapp2.default.createSelectorQuery().selectAll(query).boundingClientRect().exec(function (res) {
      var list = res[0];
      var indexs = [];
      ...
      // @ts-ignore
      if (_taroWeapp2.default[key] && typeof _taroWeapp2.default[key] === 'function') _taroWeapp2.default[key](indexs);
    });
  }, 500)();
}
...
function get(key, defaultValue) {
  var value = _taroWeapp2.default.getStorageSync(key);
...
function set(key, value) {
  _taroWeapp2.default.setStorageSync(key, JSON.stringify(value));
}
function remove(key) {
