(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["npm/taro-listview/dist/weapp/components/skeleton/index"],{
  ...
  var Skeleton = (_temp2 = _class = function (_BaseComponent) {
    ...
    _createClass(Skeleton, [{
      ...
      value: function weappSkl() {
        ...
        _taroWeapp2.default.createSelectorQuery().selectAll(selector + " >>> .skeleton-bg").boundingClientRect().exec(function (res) {
          _this3.setState({ bg: res[0] });
        });
        _taroWeapp2.default.createSelectorQuery().selectAll(selector + " >>> .skeleton-rect").boundingClientRect().exec(function (res) {
          _this3.setState({ list: res[0] });
        });
        _taroWeapp2.default.createSelectorQuery().selectAll(selector + " >>> .skeleton-radius").boundingClientRect().exec(function (res) {
      ...
      value: function _createData() {
        ...
        var anonymousState__temp = (0, _taroWeapp.internal_inline_style)({ opacity: isLoaded ? 1 : 0 });
        var anonymousState__temp2 = (0, _taroWeapp.internal_inline_style)(_extends({}, parentRect, { backgroundColor: 'white', position: 'fixed', overflow: 'hidden' }));
        var loopArray79 = !isLoaded ? bg.map(function (item, _anonIdx) {
          item = {
        ...
        var loopArray80 = !isLoaded ? list.map(function (item, _anonIdx3) {
          item = {
            $original: (0, _taroWeapp.internal_get_original)(item)
          };
        ...
        var loopArray81 = !isLoaded ? listRadius.map(function (item, _anonIdx5) {
          item = {
            $original: (0, _taroWeapp.internal_get_original)(item)
          };
    ...
    return Skeleton;
  }(_taroWeapp.Component), _class.$$events = [], _class.$$componentPath = "node_modules/taro-listview/dist/weapp/components/skeleton/index", _temp2);
...
Component(__webpack_require__(/*! @tarojs/taro-weapp */ "./node_modules/@tarojs/taro-weapp/index.js").default.createComponent(Skeleton));
...
module.exports = __webpack_require__.p + "npm/taro-listview/dist/weapp/components/skeleton/index.wxml";
