...
var AtRadio = (_temp2 = _class = function (_AtComponent) {
  ...
  _createClass(AtRadio, [{
    ...
    value: function _createData() {
      ...
      var loopArray75 = options.map(function (option, _anonIdx) {
        option = {
